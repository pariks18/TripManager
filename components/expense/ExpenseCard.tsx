            ...
            {canDirectModify ? (
              <>
                <button
                  ...
                  className="px-2.5 py-1 text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors flex items-center gap-1"
                >
                  <Edit2 className="w-3.5 h-3.5 text-slate-600" />
                  <span>{isRejected ? 'Resubmit' : 'Edit'}</span>
                </button>
                <button
                  onClick={() => onDelete(expense.id)}
                  className="px-2.5 py-1 text-xs font-bold text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-xl transition-colors flex items-center gap-1"
                >
              ...
              <button
                onClick={() => onEdit(expense)}
                className="px-2.5 py-1 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-xl transition-colors flex items-center gap-1"
              >
