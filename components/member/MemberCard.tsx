...
import { FileText, UserX, Receipt, Crown, Shield, ShieldCheck, ShieldAlert, User } from 'lucide-react';
...
export const MemberCard: React.FC<MemberCardProps> = React.memo(({
  ...
  // Current session organizer can manage role if target is NOT self and NOT primary creator
  const canManageRole = isCurrentAdmin && !isCurrentUser && !isPrimaryCreator && !!tripId;
