...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-[calc(2rem+env(safe-area-inset-bottom,0px))] md:pb-8 max-w-full overflow-x-hidden">
      {/* Sticky App Header */}
      ...
      <button
        onClick={() => setIsCreateOpen(true)}
        className="fixed right-4 bottom-[calc(1.5rem+env(safe-area-inset-bottom,0px))] z-40 w-12 h-12 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full flex items-center justify-center shadow-lg active:scale-95 transition-all sm:hidden cursor-pointer"
